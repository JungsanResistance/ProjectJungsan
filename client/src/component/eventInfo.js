...
export default class Eventinfo extends React.Component {
  ...
  componentWillMount() {
    ...
    axios.get(`http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com:3000/api/transaction?type=put&groupname=${selectedEventData.groupname}&eventname=${selectedEventData.eventname}&date=${selectedEventData.date}`)
    .then((res) => {
