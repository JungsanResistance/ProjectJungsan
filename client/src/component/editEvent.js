...
export default class EditEvent extends React.Component {
  ...
  componentWillMount() {
    ...
    // Event info
    const getEventData = axios.get(`http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com/api/transaction?type=put&groupname=${selectedEventData.groupname}&eventname=${selectedEventData.eventname}&date=${selectedEventData.date}`);
  ...
  handleSubmit() {
    ...
    axios.put('http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com/api/transaction', {
      olddate: this.state.oldDate,
      newdate: this.state.newDate,
      oldrecipient: this.state.oldrecipient,
      newrecipient: this.state.newrecipient,
