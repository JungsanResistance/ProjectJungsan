            ...
            <div className="row">
              ...
              <div className= "col-md-8">
                <ul className="nav navbar-nav navbar-right">
                  ...
                  <li className="navbarMenu"><a className="logout" href="http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com:3000logout"><b className="navbarMenu">로그아웃</b></a></li>
                </ul>
              </div>
            </div>
          </div>
