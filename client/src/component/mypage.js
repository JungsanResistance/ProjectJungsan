...
export default class Mypage extends React.Component {
  ...
  componentWillMount() {
    ...
    // const groupData = axios.get('http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com:3000/api/mypage');
  ...
  handleDone(event, index) {
    ...
    if (answer) {
      ...
      axios.put(`http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com:3000/api/misc`, individualTransacionDone)
      .then((res) => {
        if (res.status === 200) {
          if (eventValue === '정산요청') {
