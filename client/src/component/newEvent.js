...
export default class NewEvent extends React.Component {
  ...
  componentWillMount() {
    ...
    const getAllEvents = axios.get('http://ec2-52-78-69-252.ap-northeast-2.compute.amazonaws.com:3000/api/history');
  ...
  handleSubmit() {
    ...
    if (!compare) {
      ...
      axios.post('http://ec2-52-78-69-252.ap-northeast-2.compute.amazonaws.com:3000/api/transaction', {
        date: this.state.date,
        oldrecipient: this.state.oldrecipient,
        newrecipient: this.state.newrecipient,
        groupname: this.state.selectedGroup,
