...
export default class HistoryTable extends React.Component {
  ...
  handleDone(event,index) {
    ...
    axios.put(`http://http://ec2-52-78-111-241.ap-northeast-2.compute.amazonaws.com/api/history?type=${type}`, historyData)
    .then(res => {
      if(res.status === 200) {
    ...
    .then(() => {
      return axios.get('http://http://ec2-52-78-111-241.ap-northeast-2.compute.amazonaws.com/api/history');
    })
    .then((res) => {
