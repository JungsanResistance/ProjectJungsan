    ...
    this.state.myGroupList.forEach((groupname, index) => {
      this.state.adminData.forEach((group) => {
        if (group.groupname === groupname) {
          if (group.isadmin) {
            editButton =
              <Link to={'groupeditform/'+groupname}>
                <button
          ...
          <div className="container">
            ...
            <div className="col-md-10">
              <header className="jumbotron Mygroup">
                <center>
                  <h2 className="groupageHeaderText">
                    그룹 정산은 'n분의 일'에서!
                  </h2>
                </center>
                <br />
                ...
                <Link to="group">
                  <p>
                    <center>
                      <a className="btn grouppageHeaderButton">
                        그룹 추가
                      </a>
                    </center>
                  </p>
