...
export default class GroupPage extends React.Component {
  ...
  componentWillMount() {
    ...
    const pairGroupMember = axios.get(`http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com:3000/api/transaction?type=post`);
    // get isadmin data for each groupData
    const adminData = axios.get(`http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com:3000/api/mypage`);
