  ...
  transaction: (from, to, type) => {
    ...
    const sendData = {
      ...
      message: `<p><b>${from.username}</b>님께서 정산 확인을 요청하였습니다!</p>
              <p><a href="http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com">프로젝트 정산 홈페이지</a>에서 내역을 확인하신 후, 정산 수락 혹은 거절을 선택해주세요.</p>
  ...
  duplicate: (profile) => {
    ...
    const sendData = {
      ...
      message: `
              ...
              <p><a href="http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com">여기를 클릭</a>하셔서 해당 계정으로 로그인해주세요.</p>
              <p>저희 서비스를 이용해주셔서 감사합니다.</p>
              <br>
              <br>
              <p>프로젝트 정산 관리자 드림</p>
  ...
  events: (eventDetail, type) => {
    ...
    const sendData = {
      ...
      message: `
              ...
              <br>
              <p><a href="http://ec2-13-124-106-58.ap-northeast-2.compute.amazonaws.com">프로젝트 정산 홈페이지</a>
              에서 내역을 확인하실 수 있으며</p>
